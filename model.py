...
class CSRNet(nn.Module):
    def __init__(self, load_weights=False):
        ...
        self.seen = 0
        self.frontend_feature = [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 512, 512, 512]
        self.backend_feature = [512, 512, 512, 256, 128, 64]
        ...
        if not load_weights:
            ...
            self.frontend.load_state_dict(dict(frontend_dict))
    def forward(self, x):
        x = self.frontend(x)
        x = self.backend(x)
